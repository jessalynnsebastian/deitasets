...
```{r}
students$parent_attended_college <- factor(
  ifelse(
    is.na(students$parent1_edu_survey1) & is.na(students$parent2_edu_survey1),
    NA,
    students$parent1_edu_survey1 %in% c("Associate's degree", "Bachelor's degree",
                                        "Master's degree", "Doctoral degree") |
      students$parent2_edu_survey1 %in% c("Associate's degree",
                                          "Bachelor's degree",
                                          "Master's degree", "Doctoral degree")
  ),
  levels = c(FALSE, TRUE),
